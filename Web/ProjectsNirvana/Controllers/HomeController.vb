...
Public Class HomeController
    ...
    Function Explore() As ActionResult
        Return Me.Redirect("http://www.risersoft.com/Projects")
    End Function

    Function BuyApp() As ActionResult
        Dim portal As String = Me.Host.Portal.ToRootString
        Return Me.Redirect(portal & "/account/create?license=buy&product=ProjectsNirvana")
    End Function

    Function TryApp() As ActionResult
        Dim portal As String = Me.Host.Portal.ToRootString
        Return Me.Redirect(portal & "/account/create?license=try&product=ProjectsNirvana")
    End Function
End Class
